...
"""
drive_merge.py
Logic tải file từ Google Drive folder + ghép dữ liệu bảng (CSV/Excel/Google Sheets/JSON dạng bảng) -> merged.xlsx

Gợi ý dùng trong Streamlit:
- Lưu service account JSON vào st.secrets["gcp_service_account"]
"""
